...
class ColorFormatTest {
    ...
    fun formatter_SRGBIntegerTest() {
        assertEquals("0xFFFF0000", ColorFormat.SRGBInteger.formatter(Color.Red))
        assertEquals("0xFF00FF00", ColorFormat.SRGBInteger.formatter(Color.Green))
        assertEquals("0xFF0000FF", ColorFormat.SRGBInteger.formatter(Color.Blue))
        assertEquals("0xFF123456", ColorFormat.SRGBInteger.formatter(Color(0xFF123456)))
    }
    ...
    fun formatter_FloatComponentsTest() {
        ...
        assertEquals(
            "red = ${customColor.red}f, green = ${customColor.green}f, blue = ${customColor.blue}f",
